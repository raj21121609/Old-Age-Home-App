...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String userEmail = user?['email'] ?? 'priya.sharma@sunshine.com';
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    'VERSION 1.0.0 • © 2026 DEPT OF SOCIAL WELFARE',
  ...
  Widget _buildProfileBadge(LanguageProvider lang, Map<String, dynamic>? user) {
    ...
    final String userName = user?['name'] ?? 'Priya Sharma';
    final String userRole = user?['role']?.toString().toUpperCase() ?? 'CERTIFIED CARETAKER';
